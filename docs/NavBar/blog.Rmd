...
### Structure Note
When I say I am going to commit after immediately describing something. I will make the commit message the next highest header, underscore, and then the time in miltary. For example, I am going to commit now. the commit message will be strcuture note_1424
