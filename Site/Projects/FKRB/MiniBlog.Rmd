...
## Lets see it
 I am not even gonna read my code. just run it, and then look at the fits
```{r}
fitFKRB
fitCW
fitCWPlus
...
So apparently I have a bunch of dependencies that don't let it work. I have some working-ish code. But I want to walk through it on the replication page.