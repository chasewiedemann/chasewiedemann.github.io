...
&= z(X_t;\tilde \beta) + \int v(X_t;z)f_\nu(z)\, dz
\end{aligned}
$$ 
Where the final equality comes from $\lim_{N\to \infty} \frac{|R_b^N|}{N} = f_\nu$, where $f_\nu$ is the (non-parametric) density of the unobserved heterogeneity.  


# Estimating Unobserved Heterogeneity on Grids

We now look to develop an estimator of $f_\nu$ based on the derivation above. The first thing we wish to do is to remove the influence of $z(X_t;\tilde\beta)$
